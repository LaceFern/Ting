    ...
    connect_hw_server -url TCP:192.168.189.16:3122 -cs_url TCP:localhost:3052
    # Important: FPGA to program, specify Server and FPGA number, can list using script or query from Notion
    # current_hw_target 192.168.189.16:3122/xilinx_tcf/Xilinx/21770205K02TA
    current_hw_target 192.168.189.16:3122/xilinx_tcf/Xilinx/21770205K038A
