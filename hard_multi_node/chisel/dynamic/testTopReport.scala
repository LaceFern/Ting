...
class ChiselHLSTransformer extends Module{
	...
	// Collector.report(io.chisel_net_rx.bits.data(63, 0), "rx_0")
	// Collector.report(io.chisel_net_rx.bits.data(127, 64))
	// Collector.report(io.chisel_net_rx.bits.data(191, 128))
	// Collector.report(io.chisel_net_rx.bits.data(255, 192))
	// Collector.report(io.chisel_net_rx.bits.data(319, 256))
	// Collector.report(io.chisel_net_rx.bits.data(383, 320))
	// Collector.report(io.chisel_net_rx.bits.data(447, 384))
	// Collector.report(io.chisel_net_rx.bits.data(511, 448))

	// Collector.report(io.chisel_net_tx.bits.data(63, 0))
	// Collector.report(io.chisel_net_tx.bits.data(127, 64))
	// Collector.report(io.chisel_net_tx.bits.data(191, 128))
	// Collector.report(io.chisel_net_tx.bits.data(255, 192))
	// Collector.report(io.chisel_net_tx.bits.data(319, 256))
	// Collector.report(io.chisel_net_tx.bits.data(383, 320))
	// Collector.report(io.chisel_net_tx.bits.data(447, 384))
	// Collector.report(io.chisel_net_tx.bits.data(511, 448))
